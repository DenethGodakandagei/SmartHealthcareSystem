...
export default function GenerateReportPage() {
  ...
  // Available metrics (checkbox options)
  const metrics = [
  ...
  // ✅ Handle metric checkbox toggling
  ...
  const handleGenerateReport = async () => {
    ...
    try {
      const response = await API.post("/reports", {
        ...
        scheduleType: scheduleType === "immediate" ? "Custom" : scheduleType, // match schema
      });
          ...
          <div className="mx-auto max-w-4xl space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Select filters and metrics to generate hospital performance reports.
                </CardDescription>
              </CardHeader>
